...
export default function Projects({ onClose }) {
  ...
  useEffect(() => {
    ...
    const esc = (e) => {
      if (e.key === 'Escape' && !activeMission) handleClose();
    };
  ...
  return (
    <>
      <div
        ...
        onClick={(e) => {
          if (!activeMission && e.target === e.currentTarget) handleClose();
        }}
      >
        <div
          ref={panelRef}
        ...
        >
          ...
          <div
            style={{
              ...
              display: 'flex',
              flexDirection: 'column',
              opacity: activeMission ? 0.24 : 1,
              transform: activeMission ? 'scale(0.985)' : 'scale(1)',
              filter: activeMission ? 'saturate(0.75)' : 'none',
              transition: 'opacity 0.2s ease, transform 0.2s ease, filter 0.2s ease',
              pointerEvents: activeMission ? 'none' : 'auto',
            }}
          >
                  ...
                  >
                    <div
                      style={{
                        ...
                        fontSize: 9,
                        letterSpacing: '0.2em',
                        color: mission.status === 'ACTIVE' ? '#6AC46A' : 'rgba(255,255,255,0.18)',
                        fontFamily: "'Share Tech Mono',monospace",
                      }}
                    >
      ...
      {activeMission && <MissionScreen mission={activeMission} onClose={() => setActiveMission(null)} />}
    </>
  );
}
